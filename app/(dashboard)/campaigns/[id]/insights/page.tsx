 ...
 *
 * Vista de solo lectura: resumen de la automatización a la izquierda y
 * pestañas de datos y vista previa a la derecha. Ya no es la pantalla de
 * entrada — al abrir una campaña se va directo al editor, porque es lo que se
 * quiere hacer casi siempre. Esto queda a un clic desde ahí.
 */
