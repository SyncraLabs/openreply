...
/**
 * Panel — tarjetas, gráfica de 7 días y actividad reciente.
 *
 * Recibe los datos ya resueltos desde el server component: en la primera
 * carga no hay fetch, y por tanto no hay ida y vuelta a California (~300 ms
 * desde España sólo de red). Sólo vuelve a pedir datos al cambiar de cuenta,
 * que sí es una interacción.
 */
...
export default function DashboardClient({
  ...
  // La carga inicial ya viene del servidor; el primer efecto no debe repetirla.
  const yaCargado = useRef(true);
